...
            # Cek apakah result sudah diinisialisasi
            result = None
...
                    
                    # Ambil data lagi (walaupun sudah ada di `result` ini untuk line_chart)
                    weekly_data = fetch_ihsg_weekly_data()
...
    
    ...
    final_response = None
    if 'result' in locals() and isinstance(result, tuple):
